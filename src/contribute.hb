{{#> layouts/global title="Contribute to Honeycomb"}}
    ...
    <div class="grid__col grid__col--span-8-of-12">
        ...
        <p>Before making your request, double-check our <a href="https://trello.com/b/7JB1QPez/honeycomb" class="icon--external icon--right" target="_blank">Backlog and In Progress list on our Trello board</a>. If it's already there, we’re on it—no need to reach out. Feel free to subscribe to the cards to track our progress.</p>
