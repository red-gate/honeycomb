{{#> layouts/global title="Toolkits - Creating UIs" section="ui"}}
    ...
    <div class="grid__row spaced-bottom">
        <h2>MUI theme [Honeycomb MUI]</h2>

        <div class="grid__col grid__col--span-5-of-12">
            <p>Our preferred way for implementing Honeycomb in products with React UIs.</p>
     ...
     <div class="grid__row spaced-bottom">
        ...
        <div class="grid__col grid__col--span-5-of-12">
            <p>The web toolkit provides a set of reusable HTML and CSS components that can be used inside any web based project.</p>
        ...
        <div class="grid__col grid__col--span-6-of-12 grid__col--push-1-of-12">
            ...
            <p>Compiling the Honeycomb source is the preferred way of using the web toolkit as it allows settings to be customized to the projects requirements.</p>
            <ul>
