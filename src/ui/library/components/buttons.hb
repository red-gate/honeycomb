...
<section class="tabbed js-tabbed" data-tabs-pagination="true">
			<div class="band__inner-container">
				<h1 class="main-heading">Buttons</h1>
				...
				<!-- Section - Examples -->
				<section class="js-tab tabbed__content" id="examples">
  <h2>Examples</h2>
    ...
    <a class="button button--transparent button--large" href="#">Large Button</a>
				...
				<!-- SECTION - Guidelines -->
				<section class="js-tab tabbed__content" id="guidelines">
					<h2 class="visually-hidden">Guidelines</h2>

  <h2>Guidelines summary</h2>
         <p>Provide a clear call-to-action</p>
         <p>Avoid using multiple primary buttons</p>
         <p>Use buttons to guide users through a specific workflow</p>
         <p>Don’t hide buttons</p>
         <p>Don't disable buttons</p>


     <h2>Provide a clear call-to-action</h2>
        <div class="grid__col grid__col--span-12-of-12">
                    ...
                    <div class="grid__col grid__col--span-6-of-12">
                        <p class="icon--tick"></p>
                         ...
                         <p>  <a class="button button--primary" href="#">Review my changes</a> </p>
                        ...
                        <p>Use short, descriptive verbs that help users know what action they are about to perform. Use a single word only if the context of the action is clear.</p>
                 </div>                
                  
                    <div class="grid__col grid__col--span-6-of-12">
                    <p class="icon--cross"></p>
                           <p>  <a class="button button--primary" href="#">Submit</a> </p>
                           <p>  <a class="button button--primary" href="#">Changes</a> </p>
 ...
 <h2>Avoid using multiple primary buttons</h2>
      <div class="grid__col grid__col--span-12-of-12">
 ...
 <h2>Use buttons to guide users through a specific workflow</h2>
   <div class="grid__col grid__col--span-12-of-12">
               
              <div class="grid__col grid__col--span-12-of-12">
                        <p class="icon--tick icon--3x"></p>
                        <p>Primary buttons are great for guiding users through each step of a worflow</p>
                 </div>
    </div>
</div>
				...
				<section class="js-tab tabbed__content" id="case-studies">
					<h2 class="visually-hidden">Case studies</h2>

					<article class="media media--chunky">
						<figure class="media__image">
							<a class="link-image dynaLibraryAssetUrl" data-library-asset-id="163106" href="http://assets.red-gate.com/products/dba/sql-backup/assets/sql-backup-case-study.pdf" target="_blank"><img class="svg" src="/assets/INTERIM/assets/products/sql-backup/images/fully-verified-sql-server-backups-case-study.png" alt="" width="180" height="255"></a>
						</figure>
						<div class="media__body">
							<h3>"SQL Backup Pro's ease of use and reliability save us around 30 person-hours a week"</h3>
							<p>Find out how other companies have been using SQL Backup Pro to simplify their SQL Server backup and restore schedules.</p>
							<p><a href="http://assets.red-gate.com/products/dba/sql-backup/assets/sql-backup-case-study.pdf" target="_blank" class="dynaLibraryAssetUrl" data-library-asset-id="163106">Read the case study (PDF)</a></p>
						</div>
					</article>
				</section>
...
<ul class="tabs">
<li><a href="#guidelines">Guidelines</a></li>
<li><a href="#examplestab-2">Examples</a></li>
<li><a href="#code">Code</a></li>
<li><a href="#resources">Resources</a></li>
</ul>
</nav>
