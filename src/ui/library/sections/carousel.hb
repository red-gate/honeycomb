{{#> layouts/ui-library title="Carousel"}}
    ...
    <h2 class="text--separator">Options</h2>
    <table>
        <thead>
            <tr>
        ...
        <tbody>
            <tr>
                <td>Arrows</td><td>Display previous/next buttons next to the carousel.</td><td>True</td><td>data-carousel-arrows="false"</td>
            </tr>
            <tr>
                <td>Autoplay</td><td>Autoplay the carousel so that it slides without user interaction.</td><td>False</td><td>data-carousel-autoplay="true"</td>
            </tr>
        </tbody>
    </table>
